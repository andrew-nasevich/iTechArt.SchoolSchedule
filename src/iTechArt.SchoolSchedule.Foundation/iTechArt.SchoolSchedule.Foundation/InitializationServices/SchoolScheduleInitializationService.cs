...
namespace iTechArt.SchoolSchedule.Foundation.SchoolScheduleInitializationService
{
    public class SchoolScheduleInitializationService : ISchoolScheduleInitializationService
    {
        ...
        private Task InitializeLessonsTime()
        {
            return Task.Run(() =>
            {
                ...
                var context = _schoolScheduleContextFactory.CreateSchoolScheduleContext();
                using (var uow = _schoolScheduleUnitOfWorkFactory.CreateSchoolScheduleUnitOfWork(context))
                {
